...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        ...
        javascriptChannels: Set.from(_toasterJavascriptChannel(context)),
  ...
  List<JavascriptChannel> _toasterJavascriptChannel(BuildContext context) {
    return [
      JavascriptChannel(
          name: 'Toaster',
